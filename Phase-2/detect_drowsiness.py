...
# Use absolute paths when loading classifiers
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if status1 == 2 and status2 == 2:
            ...
            if count >= 10:
                cv2.putText(frame, "Fatigue Alert!!!", (100, height-20), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 2)
                if not alarm_on:
                    alarm_on = True
